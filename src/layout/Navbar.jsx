      ...
      submenus: [
        {
          ...
          items: [
            ...
            {
              label: "Blockchain Identity Management",
        ...
        },
        {
          ...
          items: [
            { label: "Supply Chain", link: "/blockchain-in-supply-chain" },
            {
              ...
              link: "/blockchain-in-transport-and-logistics",
            },
      ...
      submenus: [
        {
          ...
          items: [{ label: "AI / ML Solutions", link: "/ai-ml-solution" }],
        },
        {
          label: "Generative AI",
          items: [
      ...
      submenus: [
        {
          ...
          items: [
            {
              label: "Blockchain Consulting Company",
              link: "/blockchain-consulting-company",
            },
            {
              label: "Web3 Consulting Company",
              link: "/web3-consulting-company",
            },
            {
              label: "Metaverse Consulting Company",
              link: "/metaverse-consulting-company",
            },
            {
              label: "DeFi Consulting Company",
              link: "/defi-consulting-company",
            },
          ],
        },
        {
          ...
          items: [
            {
              label: "Marketing As A Service (MaaS)",
              link: "/marketing-as-a-service",
            },
          ],
        },
      ],
      ...
      submenus: [
        {
          ...
          items: [
            ...
            {
              label: "Margin Trading Exchange",
              link: "/margin-trading-exchange",
            },
            {
            ...
            {
              label: "Market Making Exchange",
              link: "/market-making-exchange",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "White Label NFT Development",
              link: "/white-label-nft-development",
            },
            { label: "NFT Marketplace", link: "/nft-marketplace" },
            {
              label: "Semi Fungible Token",
              link: "/semi-fungible-token-development",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              link: "/defi-decentralized-finance-development",
            },
        ...
        {
          label: "WEB3",
          items: [{ label: "Web3.0 Development", link: "/web3-development" }],
        },
        {
          ...
          items: [
            ...
            {
              label: "White Label Banking",
              link: "/white-label-banking-solution",
            },
            {
              label: "Payment Gateway",
              link: "/payment-gateway-banking-solution",
            },
        ...
        },
        {
          ...
          items: [
            {
              label: "Launchpad Development",
              link: "/launchpad-coin-development",
            },
            { label: "ICO Development", link: "/ico-coin-development" },
            {
              label: "Coin/Token Development",
              link: "/token-coin-development",
            },
            { label: "IDO Development", link: "/ido-coin-development" },
            {
              label: "Stablecoin Development",
              link: "/stable-coin-development",
            },
    ...
    <nav className="relative z-50">
      <div className="flex justify-between items-center px-6 md:px-12 lg:px-12 xl:px-32 2xl:px-32 3xl:px-60 py-4">
        ...
        <div className="hidden lg:flex space-x-10">
          ...
          >
            <button
              className="text-white text-sm xl:text-lg font-semibold hover:text-gray-300 cursor-pointer"
              aria-label="Go to blogs"
              type="button"
              title="Click to Blogs page"
            >
              Blogs
            </button>
          </Link>
        ...
        <Link to="/contact-us">
          <div className="hidden lg:block cursor-pointer">
            <button
              className="bg-green-gradient px-4 xl:px-5 py-2 2xl:py-3 rounded-full text-sm xl:text-lg font-semibold hover:scale-105 transition-transform duration-300"
              aria-label="Contact form"
              type="button"
              title="Click to access contact form"
            >
              Get In Touch
            </button>
          </div>
                        ...
                        ?.items.map((item, index) => (
                          <div key={index} className="cursor-pointer">
                            <div
                              ...
                              className="px-4 py-3 hover:bg-[#8AF969] hover:bg-opacity-10 rounded-xl p-4 mt-4 first:mt-0"
                            >
                              <p className="text-white text-[17px] font-semibold text-nowrap">
                                {item.label}
                              </p>
                            </div>
                          </div>
