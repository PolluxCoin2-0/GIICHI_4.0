  ...
  return (
    <div className="pt-6 md:pt-12 mb-20">
     ...
     {/* Blockchain Supply Chain Network */}
      <div className="relative mt-20  mb-24 pt-8 pb-8 bg-[#283430] bg-opacity-10">
        ...
        The Process of Real 
        <span className="block pt-2 text-transparent bg-clip-text bg-green-gradient">Estate Tokenization</span>
        </p>
    ...
    <div className="flex flex-row space-x-12 items-center xl:ml-[250px] 2xl:ml-[500px] mt-12">
      ...
      {/* Real Estate Tokenization Services */}
       <div className="relative mt-12 px-4 md:px-8 lg:px-12 xl:px-36 2x:px-32 3xl:px-60">
        <div className="hidden md:block spotlight spotlight-left"></div>
        <div className="hidden md:block spotlight2 spotlight-right"></div>
