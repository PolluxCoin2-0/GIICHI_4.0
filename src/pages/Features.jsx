...
const BlockchainFeatures = () => {
  return (
    <div className="px-0 md:px-32 pt-8 md:pt-12">
      {/* Heading 1 */}
      ...
      {/* Heading 2 */}
      <p className="text-white text-2xl md:text-6xl font-bold text-center pt-4 leading-tight tracking-wide">
      ...
      {/* Heading 3 */}
      <div className="flex flex-row justify-center items-center px-0 md:px-20">
      ...
      {/* Blocks */}
      <div className="flex flex-col md:flex-row justify-between space-x-0 md:space-x-6 w-full pt-8 px-0 md:px-20">
        <div className="border-2 border-white w-full md:w-[31%] rounded-3xl">
            <img src={b1Img} alt="" className=""/>
            <div className="flex flex-col p-4 md:p-6 bg-darkBlue rounded-b-3xl">
        ...
        <div className="border-2 border-white w-full md:w-[31%] rounded-3xl mt-4 md:mt-0">
        <img src={b2Img} alt="" className=""/>
        <div className="flex flex-col p-4 md:p-6 bg-navyBlue rounded-b-3xl">
        ...
        <div className="flex flex-col p-4 md:p-6 bg-blue rounded-b-3xl">
            <p className="text-white text-2xl font-bold">Blockchain</p>
            <p className="pt-2 text-white text-opacity-50 font-medium text-sm md:text-[16px]">
          Accelerate your Web3 journey with GiiCHi  <br/>CoPilot, a tailored partnership program designed to turn your vision into reality.
        </p>
