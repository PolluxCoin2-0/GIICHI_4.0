...
const Dashboard = () => {
  return (
    <div className="px-32 pt-12">
      ...
      <div className="flex flex-row justify-between items-center px-28">
        ...
        <img src={star2Img} alt="" className="" />
      </div>

      {/* Heading 2 */}
      <p className="text-white text-7xl font-bold text-center pt-4 leading-tight tracking-wide">
      ...
      <div className="flex flex-row justify-between items-center px-20">
        <img src={star3Img} alt="" className="" />
        ...
        <img src={star4Img} alt="" className="" />
      </div>

      {/* Buttons */}
      <div className="flex flex-row items-center justify-center space-x-12 pt-8">
        <button
          type="button"
          className="bg-green-gradient px-12 py-3 text-white  rounded-full text-xl"
        >
          Contact Us
        </button>
        <button
          type="button"
          className="bg-black shadow-inner shadow-lightGray text-white tex-xl px-12 py-3 rounded-full"
        >
          About GiiCHi
        </button>
      </div>
      ...
      {/* Blocks Section */}
      <div className="flex flex-row items-center space-x-4 w-full px-72 pt-20">
        <div className="w-[35%] border-[1px] border-white border-opacity-30 px-4 rounded-2xl p-4 bg-gray-gradient">
        ...
        <div className="w-[65%]">
          <div className="flex flex-row  space-x-4 border-[1px] border-white  border-opacity-30 rounded-2xl p-4 bg-gray-gradient">
            <div>
              <img src={blockImg2} alt="" className="" />
            </div>
            <div>
              <img src={blockImg3} alt="" className="" />
              <img src={blockImg4} alt="" className="mt-4" />
            </div>
          </div>
          <div className="flex flex-row space-x-4 border-[1px] border-white  border-opacity-30 rounded-2xl mt-4 p-4 bg-gray-gradient">
            <img src={blockImg5} alt="" className="w-[62%]" />
            <img src={blockImg6} alt="" className="w-[230px]" />
          </div>
        </div>
      </div>
  ...
  <div 
    className="relative mb-8 w-[60%] before:absolute before:inset-0 before:rounded-full before:h-[2px] before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent"
  ></div>
</div>
