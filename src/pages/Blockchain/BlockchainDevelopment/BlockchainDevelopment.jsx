  ...
  return (
    <div className="pt-6 md:pt-12 mb-20">
      ...
      <div className="relative mt-12 px-4 md:px-8 lg:px-12 xl:px-36 2xl:px-32 3xl:px-60">
        ...
        <p className="text-white text-2xl md:text-4xl lg:text-5xl 2xl:text-6xl font-bold pt-4 tracking-wide leading-relaxed">
          Our Blockchain
          <br />
        ...
        <p className="text-white text-opacity-70 text-sm md:text-lg lg:text-[15px] xl:text-[16px] 2xl:text-lg font-normal pt-2">
      ...
      <div className="relative text-center mt-8 md:mt-24">
        <div className="hidden md:block spotlight spotlight-left"></div>
        <div className="hidden md:block spotlight2 spotlight-right"></div>
        <p className="text-white text-2xl md:text-4xl lg:text-5xl 2xl:text-6xl font-bold pt-4 leading-tight tracking-wide px-4 md:px-8 lg:px-12 xl:px-20 3xl:px-60">
          Industries{" "}
          <span className="text-transparent bg-clip-text bg-green-gradient">
            We Serve
          </span>
        </p>
        <p className="hidden md:block text-sm md:text-[17px] text-white leading-7 text-opacity-70 pt-4 px-4 md:px-8 lg:px-12 xl:px-20 3xl:px-60">
      ...
      <div className="relative mt-12 md:mt-24 ">
        <div className="hidden md:block spotlight spotlight-left"></div>
        <div className="hidden md:block spotlight2 spotlight-right"></div>
        <p className="hidden md:block text-white text-2xl md:text-4xl lg:text-5xl 2xl:text-6xl font-bold pt-4 tracking-wide text-center px-4 md:px-8 lg:px-12 xl:px-36 2xlpx-32 3xl:px-60">
        ...
        <p className="block md:hidden text-white text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold pt-4 leading-tight tracking-wide text-center px-4 md:px-8 lg:px-12 xl:px-36 2xl:px-32 3xl:px-60">
        ...
        <p className="hidden md:block text-white text-opacity-40 pt-6 text-center text-sm md:text-[17px] lg:text-[15px] xl:text-[17px] px-4 md:px-8 lg:px-12 xl:px-36 2xl:px-32 3xl:px-60 leading-6">
      ...
      <div className="relative mt-12 2xl:mt-20 ">
        ...
        <div className="px-4 md:px-8 lg:px-12 xl:px-36 2xl:px-32 3xl:px-64 flex flex-col items-start w-full space-y-12 mt-12">
          ...
          <div className="flex flex-col md:flex-row justify-start items-start md:items-center space-x-4 md:space-x-6  lg:space-x-12 w-full">
            <div className="w-full md:w-[20%] lg:w-[30%] xl:w-[20%]">
              <p className="text-white bg-darkGray rounded-md mt-0 md:mt-8 px-4 md:px-5 py-2 md:py-3 text-sm md:text-[17px] xl:text-[14px] 2xl:px-[17px] text-nowrap text-center">
                {" "}
