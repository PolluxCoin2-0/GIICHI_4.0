    ...
    <div className="pt-6 md:pt-12 mb-20">
      ...
      <div className="hidden md:block spotlight spotlight-right"></div>
        ...
        <div className="w-full md:w-[60%] ">
          ...
          <p className="text-sm lg:text-[15px] font-normal text-white text-opacity-50 pt-6 leading-6 text-justify hyphens-auto">
          ...
          <p className="text-sm lg:text-[15px] font-normal text-white text-opacity-50 pt-8 leading-6 text-justify hyphens-auto">
      ...
      <div className="mt-8">
        ...
        <p className="text-white text-opacity-40 text-[14px] 2xl:text-[17px] pt-6 text-center px-4 md:px-8 lg:px-12 xl:px-36 2xl:px-32 3xl:px-60">
      ...
      <div className="mb-6 xl:mb-12 2xl:mb-24 mt-24">
        ...
        <p className="hidden md:block text-sm md:text-xs lg:text-[15px] text-white text-center leading-10 text-opacity-70 pt-6 px-4 md:px-8 lg:px-12 xl:px-36 2xl:px-32 3xl:px-60">
