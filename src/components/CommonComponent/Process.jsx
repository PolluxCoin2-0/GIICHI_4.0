        ...
        {processSteps.map((step, index) => (
          <div
            ...
            className={`flex flex-row space-x-8 md:space-x-12 items-center ${
              index % 2 === 0
                ? "ml-20 md:ml-40 lg:ml-4 xl:ml-32 2xl:ml-[400px]"
                : "ml-20 md:ml-40 lg:ml-[550px] xl:ml-[750px] 2xl:ml-[1000px]"
            } mt-12`}
          >
            <div>
              <p className="text-white text-[15px] md:text-2xl 2xl:text-3xl font-semibold w-[70%]">
                {step.title}
              </p>
