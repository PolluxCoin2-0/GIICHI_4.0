       ...
       {/* block section */}
        <div className="flex flex-col md:flex-row justify-center items-center space-x-0 md:space-x-12 w-full md:w-full 2xl:w-[70%]">
          <div className="flex flex-col items-center justify-center w-full md:w-[60%] mt-10">
            ...
            <p className="text-sm md:text-[17px] font-light text-white text-opacity-50 pt-6 px-0 xl:px-28 text-justify tracking-normal hyphens-auto leading-normal break-words whitespace-normal">
              {data.desc1}
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center w-full md:w-[60%] ">
            ...
            <p className="text-sm md:text-[17px] font-light text-white text-opacity-50 pt-10 px-0 xl:px-28 text-justify tracking-normal hyphens-auto leading-normal break-words whitespace-normal">
              {data.desc2}
            </p>
          </div>
        </div>
