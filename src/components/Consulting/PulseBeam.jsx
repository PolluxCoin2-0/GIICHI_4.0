  ...
  return (
    <div className="flex h-[40rem] relative items-center justify-center antialiased bg-transparent overflow-hidden">
      <a href="" target="_blank" rel="noopener noreferrer">
        <button className="bg-green-500 md:w-[320px] md:h-[120px] z-40 no-underline group cursor-pointer relative shadow-2xl shadow-green-900 rounded-full p-px text-xs font-semibold focus:outline-none 
                        leading-6 text-white inline-block" aria-label="Open menu">
